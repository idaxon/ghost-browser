...
const TRACKER_CNAMES = ['adobedtm.com','omtrdc.net','demdex.net','2o7.net','sc.omtrdc.net','data.adobedc.net',
  'siteintercept.qualtrics.com','pardot.com','tags.tiqcdn.com','ensighten.com','cdn.krxd.net',
  'pippio.com','imrworldwide.com','agkn.com','go-mpulse.net','akstat.io']
