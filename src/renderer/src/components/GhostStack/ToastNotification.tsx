...
const ENGINE_COLORS: Record<string, string> = {
  ipraw: '#6366f1', splitcast: '#eab308', temporal: '#a855f7', blocked: '#ef4444'
}
...
export default function ToastNotification({ message, engine, visible, onDismiss }: ToastProps) {
  ...
  return (
    <div id="ghoststack-toast" style={{
      ...
      <div style={{ width: 8, height: 8, borderRadius: 4, background: ENGINE_COLORS[engine] || '#6366f1', boxShadow: `0 0 8px ${ENGINE_COLORS[engine] || '#6366f1'}` }} />
