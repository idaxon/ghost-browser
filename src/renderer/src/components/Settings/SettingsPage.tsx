...
export default function SettingsPage() {
  ...
  return (
    <div className="absolute inset-0 z-[200] flex items-center justify-center p-8 animate-fade-in" style={{ background: 'rgba(5,5,10,0.85)', backdropFilter: 'blur(10px)' }}>
      <div className="flex w-full max-w-4xl h-[85vh] rounded-2xl overflow-hidden" style={{ background: '#0a0a0f', border: '1px solid #222', boxShadow: '0 24px 64px rgba(0,0,0,0.8)' }}>
        
        {/* Settings Sidebar */}
        <div className="w-64 flex flex-col" style={{ background: '#111118', borderRight: '1px solid #222' }}>
          <div className="p-5 flex items-center gap-3 border-b" style={{ borderColor: '#222' }}>
            <div style={{ width: 10, height: 10, borderRadius: 5, background: '#6366f1', boxShadow: '0 0 10px #6366f1' }} />
            ...
            {tabs.map(t => (
              <button
                ...
                style={{
                  ...
                  color: activeTab === t.id ? '#818cf8' : '#888',
